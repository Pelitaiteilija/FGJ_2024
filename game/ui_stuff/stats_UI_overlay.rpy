...
screen stats_UI_overlay():
  zorder 100
  modal False
  frame:
    id "stats_UI_overlay_frame"
...
init python:
    config.overlay_screens.append("stats_UI_overlay")